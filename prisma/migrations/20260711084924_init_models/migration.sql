/*
  ...
  - You are about to drop the column `avgerageRating` on the `doctor` table. All the data in the column will be lost.
  - You are about to drop the column `currentWorkplace` on the `doctor` table. All the data in the column will be lost.
  - You are about to drop the column `dateOfBirth` on the `doctor` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX "idx_doctor_contactno";

-- DropIndex
DROP INDEX "idx_doctor_name";

-- AlterTable
ALTER TABLE "doctor" DROP COLUMN "avgerageRating",
DROP COLUMN "currentWorkplace",
DROP COLUMN "dateOfBirth",
ADD COLUMN     "averageRating" DOUBLE PRECISION NOT NULL DEFAULT 0.0,
ADD COLUMN     "currentWorkingPlace" TEXT,
...
-- RenameIndex
ALTER INDEX "idx_patient_deleted" RENAME TO "idx_patient_isDeleted";
